...
| 16.2.2024 | 1.5  | Add validation + some comments for inline documentation to /deleteScores route + new test case for /deleteScores                       |
| 20.8.2025 | 3    | Upgrade Vercel runtime to Node 22, fix build errors, upgrade runner image to Ubuntu 22, investigate why e2e tests broke after that     |
|   21.8.   | 2    | Fix broken e2e tests                                                                                                                   |
